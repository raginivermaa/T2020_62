...
import Logo from "../../../../assets/img/dbs_side_logo.png";
            ...
            {context => (
               <div className="sidebar-header">
                  <div className="logo clearfix">
                     <NavLink to="/analytics-dashboard" className="logo-text float-left">
                        <div className="logo-img">
                           {templateConfig.sidebar.backgroundColor === "white" ? (
                              this.props.sidebarBgColor === "" || this.props.sidebarBgColor === "white" ? (
                                 <img src={LogoDark} height="5px" width="5px" alt="logo" />
                              ) : (
                                 <img src={Logo} height="5px" width="5px" alt="logo" />
                              )
                        ...
                        <span className="text align-middle">DBS</span>
                     </NavLink>
